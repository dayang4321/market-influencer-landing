...
gsap.registerPlugin(ScrollToPlugin);
   ...
   tl.addLabel("scene1")
     ...
     .addLabel("scene2")
     .to(".hero-section-one", { x: '0vw', width: '100vw', height: '35%', position: 'absolute', top: 'unset', bottom: 0 }, "scene2")
     ...
     .to(window, {scrollTo: {y: 100}, onComplete:()=>{console.log('scrolled')}}, "scene3")
